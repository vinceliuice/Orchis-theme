...
install() {
  ...
  cp -ur "${SRC_DIR}/gnome-shell/theme/checkbox${ELSE_DARK:-}.svg"                        "${THEME_DIR}/gnome-shell/assets/checkbox.svg"
  cp -ur "${SRC_DIR}/gnome-shell/theme/more-results${ELSE_DARK:-}.svg"                    "${THEME_DIR}/gnome-shell/assets/more-results.svg"
  cp -ur "${SRC_DIR}/gnome-shell/theme/toggle-on${ELSE_DARK:-}.svg"                       "${THEME_DIR}/gnome-shell/assets/toggle-on.svg"
